      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <TabsList className="grid w-full grid-cols-5 bg-white backdrop-blur-sm shadow-lg">
          ...
          <TabsContent value="shortener" className="space-y-6">
            <Suspense fallback={<div className="h-64 flex items-center justify-center"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-amber-600"></div></div>}>

...
const Index = () => {
  ...
  <div className="min-h-screen bg-black">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <TabsList className="grid w-full grid-cols-5 bg-black backdrop-blur-sm shadow-lg">
          <TabsTrigger 
            value="shortener" 
  ...
  <div className="text-center mt-12 py-6 border-t border-amber-200">
          <p className="text-sm text-white">
            © 2025 ShortLink Pro - Raccourcisseur d'URL professionnel - By <a href="https://mbl-service.com" className="text-yellow-400 hover:underline">MBL Service</a>
          </p>
        </div>
      </div>
    </div>
